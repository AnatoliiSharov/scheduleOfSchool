...
//(Long ownerId, String ownername, Optional owner, String showcase, String page, String timeview, String mode, List<String> result)
    ...
    void testCollectLectureParts(String ownername, String substitute, String exit, String result) throws Exception {
    ...
    void lookForUnoccupied(String sourcename, Long sourceId, String ownername, Long ownerId, String page,
        ...
        mockMvc.perform(get("/lectures/lecture{lectureId}/clone", lectureId.toString()).queryParam("page", page)
                .queryParam("sourcename", sourcename).queryParam("sourceId", sourceId.toString())
                .queryParam("ownername", ownername).queryParam("ownerId", "").queryParam("startDate", "2022-12-30")
                .queryParam("finishDate", "2023-01-01").queryParam("serialNumberPerDay", serialNumberPerDay.toString())
